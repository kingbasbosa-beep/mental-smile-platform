...
import 'package:mental_smile_residential_capsule/src/generation2/entry/presentation/pages/generation2_mobile_selection_pages.dart';
...
class _Generation2MobileLoginSelectionPageState
  ...
  static const String _mobileBackground =
      'packages/mental_smile_residential_capsule/assets/app/generation2_mobile_login_selection/background_mobile.webp';
  static const String _tabletBackground =
      'packages/mental_smile_residential_capsule/assets/app/generation2_mobile_login_selection/background_tablet.webp';
  ...
  static final List<_G2LoginAction> _actions = [
    _G2LoginAction(
      label: 'Ø£ØµØ¯Ù‚Ø§Ø¡',
      assetPath:
          'packages/mental_smile_residential_capsule/assets/images/mobile/splash/btn_friend.webp',
      imageScale: 1.08,
    ...
    _G2LoginAction(
      label: 'Ø¯Ø§Ø¹Ù…ÙŠÙ†',
      assetPath:
          'packages/mental_smile_residential_capsule/assets/images/mobile/splash/btn_supporter.webp',
      imageScale: 0.86,
  ...
  void _openAction(_G2LoginAction action) {
    Navigator.of(
      context,
    ).push(MaterialPageRoute<void>(builder: action.builder));
  }
                  ...
                  children: [
                        ...
                        gradient: LinearGradient(
                          ...
                          colors: [
                            ...
                            Colors.black.withValues(
                              alpha: isMobile ? 0.28 : 0.18,
                            ),
                            Colors.black.withValues(
                              alpha: isMobile ? 0.62 : 0.48,
                            ),
                          ],
                        ),
                      ),
                    ...
                    Positioned(
                      ...
                      child: const DaleelAssistant(
                        iconOnly: true,
                        guideAssetPath:
                            'packages/mental_smile_residential_capsule/assets/branding/guides/mobile_login_selection_guide.png',
                        surveyTitle: 'Ø±Ø£ÙŠÙƒ ÙŠÙ‡Ù…Ù†Ø§',
                        surveyIntro:
                            'Ø³Ø§Ø¹Ø¯Ù†Ø§ ÙÙŠ ØªØ­Ø³ÙŠÙ† Ø´Ø§Ø´Ø© Ø§Ø®ØªÙŠØ§Ø± Ø§Ù„Ø¯Ø®ÙˆÙ„ Ø¥Ù„Ù‰ Ù…Ù†ØµØ© Mental Smile.\n\n'
                            'Ù„Ù† ÙŠØ³ØªØºØ±Ù‚ Ù‡Ø°Ø§ Ø§Ù„Ø§Ø³ØªØ¨ÙŠØ§Ù† Ø³ÙˆÙ‰ Ø¯Ù‚ÙŠÙ‚Ø© ÙˆØ§Ø­Ø¯Ø©.',
                        suggestionsPlaceholder:
                            'Ø§ÙƒØªØ¨ Ø£ÙŠ Ø§Ù‚ØªØ±Ø§Ø­ ÙŠØ³Ø§Ø¹Ø¯Ù†Ø§ ÙÙŠ ØªØ·ÙˆÙŠØ± Ø´Ø§Ø´Ø© Ø§Ø®ØªÙŠØ§Ø± Ø§Ù„Ø¯Ø®ÙˆÙ„...',
                        sections:
                        ...
                        extraTextFields: [
                          DaleelSurveyTextFieldData(
                            ...
                            placeholder:
                                'Ø§ÙƒØªØ¨ Ø£ÙŠ Ø§Ù‚ØªØ±Ø§Ø­ ÙŠØ³Ø§Ø¹Ø¯Ù†Ø§ ÙÙŠ ØªØ­Ø³ÙŠÙ† Ø³Ù‡ÙˆÙ„Ø© Ø§Ø³ØªØ®Ø¯Ø§Ù… Ø§Ù„ØµÙØ­Ø© Ø£Ùˆ Ø¥Ø¶Ø§ÙØ© ÙˆØ³Ø§Ø¦Ù„ Ù…Ø³Ø§Ø¹Ø¯Ø© Ø¬Ø¯ÙŠØ¯Ø©...',
                          ),
                        ],
                        suggestionsTitle:
...
class _LanguageAction extends StatelessWidget {
  const _LanguageAction({required this.onPressed, required this.imageSize});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Column(
        ...
        children: [
          Image.asset(
            'packages/mental_smile_residential_capsule/assets/images/mobile/splash/btn_language.webp',
            width: imageSize,
            height: imageSize,
            fit: BoxFit.contain,
          ),
