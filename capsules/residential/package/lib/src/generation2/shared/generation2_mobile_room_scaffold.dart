...
class _Generation2MobileRoomScaffoldState
  ...
  static const String _mobileBackground =
      'packages/mental_smile_residential_capsule/assets/images/mobile/client_room/background_mobile.webp';
  static const String _tabletBackground =
      'packages/mental_smile_residential_capsule/assets/images/mobile/client_room/background_tablet.webp';
  static const String _cardsStrip =
      'packages/mental_smile_residential_capsule/assets/images/mobile/client_room/client_cards_strip.webp';
  static const String _clientImageFrame =
      'packages/mental_smile_residential_capsule/assets/images/mobile/client_room/frame_client_image.webp';
          ...
          child: SafeArea(
            child: Padding(
              ...
              child: TextButton(
                ...
                child: const Text(
                  'Ø§Ø±ÙØ¹ ØµÙˆØ±Ø© Ù„Ø­Ø¯ Ø¨ØªØ­Ø¨Ù‡',
  ...
  String? _routeForCardTitle(String title) {
    switch (title) {
      case 'Ø·Ù…Ù‘Ù†Ø§ Ø¹Ù„ÙŠÙƒ':
        return Routes.accessibilityCheckin;
      case 'ØªØ·Ø¨ÙŠÙ‚Ø§Øª':
        return Routes.accessibilityCommunityTools;
      case 'ØªØ·Ø¨ÙŠÙ‚Ø§Øª ÙˆØ£Ø¯ÙˆØ§Øª':
        return Routes.accessibilityCommunityTools;
      case 'Ø´Ø§Ø±Ùƒ Ø¨Ø§Ù‚ØªØ±Ø§Ø­':
        return Routes.accessibilitySuggestions;
      case 'Ø´Ø§Ø±ÙƒÙ†Ø§ Ø¨Ø§Ù‚ØªØ±Ø§Ø­':
        return Routes.accessibilitySuggestions;
      case 'Ø¨ÙˆØ§Ø¨Ø© Ø§Ù„Ø£Ø¯ÙˆØ§Øª Ø§Ù„Ù…Ø³Ø§Ø¹Ø¯Ø©':
        return Routes.accessibilityTools;
      case 'Ø£Ø¯ÙˆØ§ØªÙƒ':
        return Routes.accessibilityTools;
      case 'Ù„ÙŠÙ†ÙƒØ§ØªÙƒ':
        return Routes.accessibilityLinks;
      case 'Ø¨ÙˆØ§Ø¨Ø© Ø§Ù„Ø±ÙˆØ§Ø¨Ø· Ø§Ù„Ù…Ù‡Ù…Ø©':
        return Routes.accessibilityLinks;
      case 'Ø§Ù„Ù„ÙŠÙ†ÙƒØ§Øª':
        return Routes.accessibilityLinks;
      case 'Ø§Ù„Ù…Ù„Ù Ø§Ù„Ù…Ù‡Ù†ÙŠ':
        return Routes.commercialSpecialistProfessionalProfile;
      case 'Ø§Ù„Ù…ÙƒØªØ¨Ø© Ø§Ù„Ù…Ù‡Ù†ÙŠØ©':
        return Routes.commercialSpecialistProfessionalLibrary;
      case 'Ø£Ø¯ÙˆØ§Øª Ù…Ø³Ø§Ø¹Ø¯Ø©':
        return Routes.commercialAssistiveTools;
      case 'Ù…Ù„Ù Ø§Ù„Ù…Ø±ÙƒØ²':
        return Routes.commercialCenterProfessionalProfile;
      case 'Ø§Ù„Ù…ÙƒØªØ¨Ø© Ø§Ù„Ù…Ù‡Ù†ÙŠØ© Ù„Ù„Ù…Ø±Ø§ÙƒØ²':
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  height: (mediaSize.height * 0.022).clamp(
                                    8.0,
                                    18.0,
                                  ),
                                ),
...
class _LogoHeader extends StatelessWidget {
  const _LogoHeader({required this.logoHeight, required this.onSpeak});
  ...
  Widget build(BuildContext context) {
    return Transform.translate(
      ...
      child: Row(
        ...
        children: [
          Image.asset(
            'packages/mental_smile_residential_capsule/assets/branding/logo_primary.png',
            height: logoHeight,
            fit: BoxFit.contain,
          ),
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                const Flexible(
                                  child: Text(
                                    'ØªØ­Ø¨ ØªÙ‚ÙˆÙ„ Ù„ØµØ§Ø­Ø¨ Ø§Ù„ØµÙˆØ±Ø© Ø§ÙŠÙ‡ØŸ',
                                    maxLines: 1,
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: const Color(
              0xFFE0C174,
            ).withValues(alpha: selected ? 0.86 : 0.46),
          ),
        ),
        child: Padding(
...
class _ExitButton extends StatelessWidget {
  const _ExitButton({required this.onPressed, required this.onSpeak});
...
class _GoldHalo extends StatelessWidget {
  const _GoldHalo({required this.child, this.size = 30});
