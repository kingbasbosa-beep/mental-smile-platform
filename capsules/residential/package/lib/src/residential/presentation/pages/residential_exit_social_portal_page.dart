...
class ResidentialExitSocialPortalPage extends StatelessWidget {
  ...
  static const String _background =
      'packages/mental_smile_residential_capsule/assets/backgrounds/residential_exit_social_portal.webp.png';
...
class _DesktopPortalLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        const Positioned(top: 78, left: 0, right: 0, child: _PortalMessage()),
        Positioned(
          top: 222,
          left: 0,
          right: 0,
...
class _ExitButtonState extends State<_ExitButton> {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      ...
      hint: SharedLocalizations.of(
        context,
      ).applicationAccessibilityListenSupport,
      child: MouseRegion(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: const Color(
                  0xFFFFD77A,
                ).withValues(alpha: _hovered ? 0.92 : 0.62),
              ),
              boxShadow: [
                BoxShadow(
                  color: const Color(
                    0xFFFFB43A,
                  ).withValues(alpha: _hovered ? 0.38 : 0.22),
