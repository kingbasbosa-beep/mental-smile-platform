...
class AccessibilityMessageOfDayPage extends StatelessWidget {
  ...
  static const String _background =
      'packages/mental_smile_residential_capsule/assets/accessibility/accessibility_message_of_day/accessibility_message_of_day_papyrus_background.png';
                        ...
                        child: ConstrainedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              Semantics(
                                header: true,
                                label: ResidentialLocalizations.of(
                                  context,
                                ).applicationClientFeatherNotebook,
                                child: _SpeakableText(
                                  text:
                                      'ðŸŒ¿ ${ResidentialLocalizations.of(context).applicationClientFeatherNotebook}',
                              ...
                              _SpeakableText(
                                text:
                                    'ðŸ“ ${l10n.applicationAccessibilityDialogSelectMessage}',
                                onSpeak: () => _speakLocalizedLabel(
                                  context,
                                  localizationKey:
...
class _LocalizedMessage {
  const _LocalizedMessage({required this.key, required this.text});
