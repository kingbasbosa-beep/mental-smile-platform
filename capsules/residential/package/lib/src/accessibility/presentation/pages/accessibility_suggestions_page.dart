...
class _AccessibilitySuggestionsPageState
  ...
  static const String _background =
      'packages/mental_smile_residential_capsule/assets/accessibility/accessibility_suggestions/accessibility_suggestions_papyrus_background.png';
  ...
  Future<void> _submitSuggestion(AccessibilityLocalizations l10n) async {
    ...
    if (toolName.isEmpty || reason.isEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(l10n.applicationAccessibilitySuggestionsValidation),
        ),
      );
      return;
    }
                            ...
                            children: [
                              Semantics(
                                ...
                                child: _SpeakableText(
                                  text:
                                      'ðŸ’¡ ${l10n.applicationAccessibilitySuggestionsCardTitle}',
                              ...
                              _SpeakableText(
                                text:
                                    'ðŸ› ï¸ ${l10n.applicationAccessibilitySuggestionsCardSubtitle}',
                                onSpeak: () => _speakLocalizedLabel(
                                  context,
                                  localizationKey:
                                ...
                                children: [
                                  Semantics(
                                    ...
                                    child: TextButton(
                                      ...
                                      child: Text(
                                        'ðŸ“¨ ${l10n.applicationAccessibilitySuggestionsSubmitButton}',
                                        textAlign: TextAlign.center,
                                        style: const TextStyle(
                                          fontSize: 16,
                                          fontWeight: FontWeight.w800,
