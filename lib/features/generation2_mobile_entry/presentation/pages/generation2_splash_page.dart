...
class _Generation2SplashPageState extends ConsumerState<Generation2SplashPage> {
  ...
  static const List<_G2SplashAction> _actions = [
    _G2SplashAction(
      label: 'موبيل',
      assetPath: 'assets/images/mobile/splash/btn_mobile.webp.png',
      routeName: Routes.generation2MobileLoginSelection,
    ),
    _G2SplashAction(
      label: 'ديسكتوب',
      assetPath: 'assets/images/mobile/splash/btn_desktop.webp.png',
      routeName: Routes.legacySplash,
    ),
    _G2SplashAction(
      label: 'اللغة',
      assetPath: 'assets/images/mobile/splash/btn_language.webp.png',
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          colors: [
                            ...
                            Colors.black
                                .withValues(alpha: isMobile ? 0.46 : 0.34),
                          ],
                        ),
                      ),
                    ),
