  ...
  Widget build(BuildContext context) {
    return const Generation2MobileRoomScaffold(
      ...
      daleelAssistant: DaleelAssistant(
        ...
        surveyIntro:
            'ساعدنا في تطوير شاشة صديقي المميز لتوفير أفضل تجربة ممكنة.\n\n'
        ...
        extraTextFields: [
          DaleelSurveyTextFieldData(
            sectionTitle: 'مقترحات لتحسين وسائل الاستخدام',
            label: 'شاركنا أفكارك',
            placeholder:
                'إذا كانت لديك أي اقتراحات لتحسين وسائل الاستخدام أو إضافة أدوات جديدة، يسعدنا سماع رأيك.',
          ),
        ],
        suggestionsTitle: 'اقتراحات عامة',
        suggestionsLabel: 'اقتراحاتك تهمنا',
        suggestionsPlaceholder:
            'اكتب أي اقتراح يساعدنا في تطوير شاشة صديقي المميز...',
      ),
    );
  }
}
