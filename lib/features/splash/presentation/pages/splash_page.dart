          ...
          children: [
            ...
            Positioned(
              ...
              child: const DaleelAssistant(
                guideAssetPath:
                    'assets/branding/guides/welcome_screen_guide.png',
              ),
            ),
            Align(
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      ...
      child: TextButton.icon(
        ...
        style: TextButton.styleFrom(
          foregroundColor:
              publicWeb ? const Color(0xFFFFF1C2) : const Color(0xFFFFE8A3),
