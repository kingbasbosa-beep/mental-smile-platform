...
class _ClientSupportSpacePageState extends State<_ClientSupportSpacePage> {
  ...
  void _submitMessage() {
    ...
    if (validationMessage != null) {
      ...
      final reason =
          validationMessage == _safeSpaceError ? 'denylist' : 'validation';
      debugPrint(
        'support_space_message_blocked reason=$reason',
      );
      return;
    }
  ...
  Widget build(BuildContext context) {
    return OutlinedButton.icon(
      ...
      style: OutlinedButton.styleFrom(
        ...
        backgroundColor:
            selected ? const Color(0xFFE0C174) : const Color(0xFF1B1007),
        side: BorderSide(
