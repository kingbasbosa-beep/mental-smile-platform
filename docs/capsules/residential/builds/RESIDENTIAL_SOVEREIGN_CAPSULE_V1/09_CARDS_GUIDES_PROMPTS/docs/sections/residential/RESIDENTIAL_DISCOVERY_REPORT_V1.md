...
| Accessibility Check-In Page | Local 5-question UI; WhatsApp opens with fixed check-in message and does not send answers | Active | `url_launcher`, specialist and center library branches, papyrus background asset |
