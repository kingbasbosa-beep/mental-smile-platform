...
class LibrarySpecialistsPage extends StatelessWidget {
  const LibrarySpecialistsPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return const _LibraryProviderCategoryListPage(
      title: 'الأخصائيون',
      intro:
...
class LibraryCentersPage extends StatelessWidget {
  const LibraryCentersPage({super.key});
        ...
        child: Column(
          children: [
            ...
            const Align(
              ...
              child: Padding(
                padding: EdgeInsetsDirectional.only(start: 18, top: 4),
                child: _BackToLibraryButton(
                  sourceScreen: 'Library Provider Category List',
...
class FutureContentSurface extends StatelessWidget {
  const FutureContentSurface({required this.branch});
